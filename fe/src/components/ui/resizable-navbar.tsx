  ...
  return (
    ...
    >
      <img
        ...
        height={30}
      />
      <span className="font-medium text-black dark:text-white">MTasks</span>
    </a>
  );
};
...
export const NavbarButton = ({
  ...
  const variantStyles = {
    ...
    secondary:
      "bg-neutral-700 text-white shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset]",
    dark:
    ...
    ghost:
      "bg-transparent hover:bg-neutral-100 dark:hover:bg-neutral-800 text-black dark:text-white shadow-none",
  };

  const sizeStyles = {
    default: "px-4 py-2 h-10",
    icon: "pt-1 pb-1 px-2 h-10 w-10", // Less top padding for higher alignment
  };
